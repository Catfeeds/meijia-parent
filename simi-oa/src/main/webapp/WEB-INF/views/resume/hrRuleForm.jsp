...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			<section class="panel"> <header class="panel-heading"> 简历解析规则库 </header>
					...
					<div class="col-lg-8" >
						...
						<div class="panel-body">
							...
							<div class="form-body">
								...
								<div class="form-group required">
									<label class="col-md-2 control-label">匹配字段</label>
									<div class="col-md-8">
										<form:select path="matchDictId" class="form-control">
											<form:option value="">请选择匹配字段</form:option>
											<form:options items="${hrDicts}" itemValue="id" itemLabel="name" />
										</form:select>
										<form:errors path="fromId" class="field-has-error"></form:errors>
									</div>
								</div>
								...
								<div class="form-group required">
									...
									<div class="col-md-8">
										<form:select path="sampleType" class="form-control">
											<form:option value="textarea">样本源码</form:option>
											<form:option value="upload">样本上传</form:option>
										</form:select>
									</div>
								</div>
						...
						<div class="panel-body">
							...
							<div class="form-group required">
								...
								<div class="col-md-8">
									<form:select path="textOrHtml" class="form-control">
						...
						<div class="panel-body">
							<div class="form-group required">
								<label class="col-md-2 control-label">对应的字典类型</label>
								<div class="col-md-8">
									<form:select path="matchDictTypeId" class="form-control">
											<form:option value="0">无</form:option>
											<form:options items="${hrDictType}" itemValue="id" itemLabel="typeName" />
									</form:select>
								</div>
							</div>
						</div>
	...
	<script src="<c:url value='/js/simi/resume/hrRuleForm.js'/>" type="text/javascript"></script>
