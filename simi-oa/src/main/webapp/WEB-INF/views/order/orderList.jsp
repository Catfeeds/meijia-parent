...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			<section class="panel"> <form:form modelAttribute="oaOrderSearchVoModel" action="list" method="GET">
			...
			<tbody>
				<c:forEach items="${contentModel.list}" var="item">
					<tr>
						...
						<td>${ item.orderPay }</td>
						<td><button id="btn_update" onClick="btn_update('order/orderView?orderNo=${item.orderNo }')"
