	...
	<div class="row">
		<div class="col-lg-12">
			<section class="panel"> <form:form
				modelAttribute="oaOrderSearchVoModel" action="greenList"
				method="GET">
		...
		<div class="pull-right">
			<button onClick="btn_add('order/orderGreenAddForm?id=0')"
				...
				<c:forEach items="${contentModel.list}" var="item">
					<tr>
						...
						<td><button id="btn_update"
								onClick="btn_update('order/orderGreenView?orderNo=${item.orderNo }')"
