...
<body>
		...
		<div class="col-lg-12">
			...
			<div class="panel-body">
				<form:form modelAttribute="contentModel" class="form-horizontal"
					method="POST" action="saveOrderWater" id="order-water-view-form"
				...
				<%-- 	<form:hidden path="id" /> --%>
					<div class="form-body">
					    ...
					    <div class="form-group">
							...
							<div class="col-md-5">
								<form:select path="servicePriceId" id="servicePriceId" name="servicePriceId" class="form-control">
									...
									<form:options items="${waterComVos}" itemValue="servicePriceId"
										itemLabel="namePrice"/>
								</form:select>
							</div>
						</div>
						<div class="form-group required">
							...
							<div class="col-md-5">
								<form:input path="serviceNum" class="form-control"
									maxLength="32" />
						...
						<div class="form-group required">
							...
							<div class="col-md-5">
								<form:input path="linkTel" class="form-control"
									maxLength="32" />
	...
	<script type="text/javascript"
			src="<c:url value='/js/simi/order/orderWaterForm.js'/>"></script>
