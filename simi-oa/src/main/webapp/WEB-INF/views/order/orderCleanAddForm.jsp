...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="panel-body">
				<form:form modelAttribute="contentModel" class="form-horizontal" method="POST" action="saveOrderCleanAdd"
					id="order-clean-add-form">
					...
					<div class="form-body">
						...
						<div class="form-group required">
							...
							<div class="col-md-5">
								<form:select path="cleanType" class="form-control">
	...
	<script type="text/javascript" src="<c:url value='/js/simi/order/orderCleanAddForm.js'/>"></script>
