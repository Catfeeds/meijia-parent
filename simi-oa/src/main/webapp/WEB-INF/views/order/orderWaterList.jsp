...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			<section class="panel"> <form:form
				modelAttribute="oaOrderSearchVoModel" action="waterList"
				method="GET">
		...
		<div class="pull-right">
			<button onClick="btn_add('order/orderWaterAddForm?id=0')"
		...
		<c:param name="urlAddress" value="/order/waterList" />
	</c:import>
	</div>
	</div>
	...
	<script src="<c:url value='/js/simi/order/orderWaterList.js'/>"></script>
</body>
</html>