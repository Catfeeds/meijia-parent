...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			<section class="panel"> <form:form modelAttribute="oaOrderSearchVoModel" action="cleanList" method="GET">
			...
			<tbody>
				<c:forEach items="${contentModel.list}" var="item">
					<tr>
						...
						<td><button id="btn_update" onClick="btn_update('order/orderCleanForm?orderId=${item.orderId }')"
		...
		<c:param name="urlAddress" value="/order/cleanList" />
	</c:import>
	</div>
	</div>
	...
	<script src="<c:url value='/js/simi/order/orderCleanList.js'/>"></script>
</body>
</html>