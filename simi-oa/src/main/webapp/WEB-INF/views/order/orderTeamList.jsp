...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			<section class="panel"> <form:form modelAttribute="oaOrderSearchVoModel" action="teamList" method="GET">
		...
		<div class="pull-right">
			<button onClick="btn_add('order/orderTeamAddForm?id=0')" class="btn btn-primary" type="button">
			...
			<tbody>
				<c:forEach items="${contentModel.list}" var="item">
					<tr>
						...
						<td>${ item.orderPay }</td>
						<td><button id="btn_update" onClick="btn_update('order/orderTeamForm?orderNo=${item.orderNo }')"
