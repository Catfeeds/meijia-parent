...
<body>
		...
		<div class="col-lg-12">
			...
			<div class="panel-body">
				<form:form modelAttribute="contentModel" class="form-horizontal"
					method="POST" action="saveOrderRecycle" id="order-recycle-view-form"
			...
			<div class="form-body">
				<form:form modelAttribute="orderExtPartner" class="form-horizontal" method="POST" action="saveOrderRecyclePartner"
					id="order-recycle-partner-form"
				>
					<form:hidden path="id" />
	...
	<script type="text/javascript"
			src="<c:url value='/js/simi/order/orderRecycleForm.js'/>"></script>
