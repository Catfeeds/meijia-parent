...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="panel-body">
				<form:form modelAttribute="contentModel" class="form-horizontal" method="POST" action="saveOrderGreenAdd"
					id="order-green-add-form">
	...
	<script type="text/javascript" src="<c:url value='/js/simi/order/orderGreenAddForm.js'/>"></script>
