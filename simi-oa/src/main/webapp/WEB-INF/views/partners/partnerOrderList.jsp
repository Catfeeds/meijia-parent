...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			<section class="panel">
			 <%--  <form:form modelAttribute="oaOrderSearchVoModel" action="list" method="GET">
				...
				<tbody>
					<c:forEach items="${contentModel.list}" var="item">
						<tr>
							...
							<td>${ item.orderPay }</td>
							<td><button id="btn_update" onClick="btn_update('order/orderView?orderNo=${item.orderNo }')" class="btn btn-primary btn-xs" title="订单详情"><i class=" icon-ambulance"></i></button></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
			...
			<c:import url="../shared/paging.jsp">
				...
				<c:param name="urlAddress" value="/partners/partnerOrderlist" />
			</c:import>
		</div>
	</div>
