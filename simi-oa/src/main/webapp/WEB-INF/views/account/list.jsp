<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
	import="com.zrj.oa.common.UrlHelper" %>
...
<head>
   ...
   <script type="text/javascript" src="<c:url value='/js/jquery.tableManaged.js'/>">
            ...
            <div class="col-md-12">
				...
				<div class="portlet box light-grey">
				   ...
				   <div class="portlet-body form">
					  <!-- BEGIN FORM-->
					  <form:form modelAttribute="searchModel" class="form-horizontal" method="GET" id="account-list">
						 ...
						 <div class="col-md-6">
								<div class="col-md-offset-1">                                 
									<button class="btn btn-large  btn-success" type="button" onclick="window.location.href='register?id=0'">新增</button>
								</div>
							</div> 
						</div>
						 </div>
               ...
               <div class="portlet box light-grey">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-table"></i>数据列表${requestScope.permissionMenu.curName}</div>
                  </div>
		                     ...
		                     <table class="table table-striped table-bordered table-hover" id="data-table">
		                        ...
		                        <tbody>
							        ...
							        <tr class="odd gradeX">
							           ...
							           <td>
							               <%--  <a href="${pageContext.request.contextPath}/account/authorize/${item.id}">账户绑定</a>	
							               <a href="${pageContext.request.contextPath}/account/enable/${item.id}">启用</a>
							               <a href="${pageContext.request.contextPath}/account/disable/${item.id}">禁用</a>	 --%>
		            		               <a href="${pageContext.request.contextPath}/account/register?id=${item.id}">修改</a>
							               <a href="${pageContext.request.contextPath}/account/delete/${item.id}" onClick="return confirm('确定要删除吗？');">删除</a>         
							           </td>
							        </tr>
							        </c:forEach>
		                        </tbody>
