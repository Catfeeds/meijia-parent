...
<html>
  <head>
	...
	<!--css for this page-->
    <link href="<c:url value='/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css'/>" rel="stylesheet" type="text/css" media="screen"/>
  ...
  <section id="container" >
    ...
    <script src="<c:url value='/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js'/>"></script>
    <script src="<c:url value='/assets/owl.carousel.js'/>" ></script>
    <script src="<c:url value='/js/sparkline-chart.js'/>"></script>
    <script src="<c:url value='/js/easy-pie-chart.js'/>"></script>
