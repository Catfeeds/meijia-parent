...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			...
			</form:form>  --%> <header class="panel-heading"> app帮助列表

			<div class="pull-right">
				<button onClick="btn_add('/op/appHelpForm?id=0')"
						...
						<tr>
							...
							<td>
								<button id="btn_update"
									onClick="btn_update('/op/appHelpForm?id=${item.id}')"
			...
			<c:import url="../shared/paging.jsp">
				...
				<c:param name="urlAddress" value="/op/appHelp_list" />
			</c:import>
		</div>
	</div>
