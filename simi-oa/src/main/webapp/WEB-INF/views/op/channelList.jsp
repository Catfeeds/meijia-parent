	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="pull-right">
				<button onClick="btn_add('/op/channelForm?channel_id=0')"
						...
						<tr>
							...
							<td>
								<button id="btn_update"
									onClick="btn_update('/op/channelForm?channel_id=${item.channelId}')"
			...
			<c:import url="../shared/paging.jsp">
				...
				<c:param name="urlAddress" value="/op/channel_list" />
			</c:import>
		</div>
	</div>
