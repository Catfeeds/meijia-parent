...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="panel-body">
				<form:form modelAttribute="channelModel" class="form-horizontal" method="POST" action="channelForm"
					id="channel-form" enctype="multipart/form-data">
					...
					<div class="form-body">
						<div class="form-group required">
							...
							<div class="col-md-5">
								<form:input path="name" class="form-control" placeholder="标题" maxLength="32" />
							...
							<div class="col-md-10">
								<div class="row">
									<div class="col-md-2" align="right">
										<label class="radio"> <input value="0" name="enable" type="radio"> 不可用
										</label>
									</div>
									<div class="col-md-2" align="left">
										<label class="radio"> <input checked="checked" value="1" name="enable" type="radio"> 可用
										</label>
									</div>
								</div>
							</div>
	...
	<script src="<c:url value='/js/simi/op/channelForm.js'/>" type="text/javascript"></script>
