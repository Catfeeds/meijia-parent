...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="panel-body">
				<form:form modelAttribute="serviceTypeModel" class="form-horizontal"
					method="POST" action="serviceTypeForm" id="dict-form">
					<form:hidden path="id" />
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<form:input path="tips" class="form-control placeholder-no-fix"
								autocomplete="off" placeholder="提示语" />
							<br />
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<form:input path="price" class="form-control placeholder-no-fix"
								autocomplete="off" placeholder="单价" />
							<br />
	...
	<script src="<c:url value='/js/simi/dict/serviceTypeForm.js'/>"type="text/javascript"></script>
