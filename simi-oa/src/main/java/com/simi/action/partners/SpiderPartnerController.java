...
public class SpiderPartnerController extends BaseController{
   ...
   // @AuthPassport
	...
	public String spiderPartnerForm(Model model, HttpServletRequest request,
		...
		List<TreeModel> children=TreeModelExtension.ToTreeModels(partnerServiceTypeService.listChain(new ArrayList<Long>()), null, checkedPartnerTypeIntegers, StringHelper.toIntegerList( expanded, ","));
