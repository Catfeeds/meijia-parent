...
public class OrderStatusSelectTag extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        try {
        	...
        	List<String> optionList = OneCareUtil.getOrderStatus();


            StringBuffer serviceTypeSelect = new StringBuffer();
            serviceTypeSelect.append("<select id = \"citySelect\" name=\"orderStatus\" class=\"form-control\">");
