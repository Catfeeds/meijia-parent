...
var appkey = "yougeguanjia#simi";
var time = 0;
var isLogin = null;

var im_username = queryVal('im_username');
var im_password = queryVal('im_password');
curUserId = queryVal('to_im_user');
var to_im_name = queryVal('to_im_name');
...
//		showLoginUI();
//		login();
		if (typeof im_username != undefined && typeof im_password != undefined) {
			login();
		}
	}
	//发送文件的模态窗口
...
var login = function() {
	console.log("login");
	$('#waitLoginmodal').modal('show');
	console.log($('#waitLoginmodal').css("modal"));
	
//	hiddenLoginUI();
//	console.log(im_username);
//	console.log(im_password);
	showWaitLoginedUI();
//	//根据用户名密码登录系统
//	conn.open({
//		apiUrl : apiURL,
