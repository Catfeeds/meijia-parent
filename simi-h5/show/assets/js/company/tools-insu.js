function cityChangeExtend() {
	...
	$.ajax({
		...
		success : function(data) {
			...
			$("#socialInsurance").val(result.shebao_min);
			$("#fundPrice").val(result.gjj_min);
		},
		error : function() {
			return false;
		}
...
$("#calculate").on("click",function() {
	...
	$.ajax({
		type : "get",
		url : appRootUrl + "insurance/get_insurance.json",
		data : params,
		dataType : "json",
		cache : true,
		success : function(data) {
			...
			// 养老
			var pensionHtml = "<tr >" + "<td>养老</td>" + "<td>" + pensionP
					+ "(<font color='red'>" + result.pension_p + "%</font>)</td>" + "<td>"
					+ pensionC + "(<font color='red'>" + result.pension_c
					+ "%</font>)</td>" + "</tr>";
			// 医疗
			var medicalHtml = "<tr >" + "<td>医疗</td>" + "<td>" + medicalP
					+ "(<font color='red'>" + result.medical_p + "%</font>)</td>" + "<td>"
					+ medicalC + "(<font color='red'>" + result.medical_c
					+ "%</font>)</td>" + "</tr>";
			// 失业
			var unemploymentHtml = "<tr >" + "<td>失业</td>" + "<td>" + unemploymentP
					+ "(<font color='red'>" + result.unemployment_p + "%</font>)</td>"
					+ "<td>" + unemploymentC + "(<font color='red'>"
					+ result.unemployment_c + "%</font>)</td>" + "</tr>";
			
			// 工伤
			var injuryHtml = "<tr >" + "<td>工伤</td>" + "<td>" + injuryP
					+ "(<font color='red'>" + result.injury_p + "%</font>)</td>" + "<td>"
					+ injuryC + "(<font color='red'>" + result.injury_c + "%</font>)</td>"
					+ "</tr>";
			// 生育
			var birthHtml = "<tr >" + "<td>生育</td>" + "<td>" + birthP
					+ "(<font color='red'>" + result.birth_p + "%</font>)</td>" + "<td>"
					+ birthC + "(<font color='red'>" + result.birth_c + "%</font>)</td>"
					+ "</tr>";
			// 公积金
			var fundHtml = "<tr >" + "<td>公积金</td>" + "<td>" + fundP
					+ "(<font color='red'>" + result.fund_p + "%</font>)</td>" + "<td>"
					+ fundC + "(<font color='red'>" + result.fund_c + "%</font>)</td>"
					+ "</tr>";
			
			// 合计
			var sumHtml = "<tr class='am-active'>" + "<td>合计</td>" + "<td>"
					+ sumP.toFixed(2) + "</td>" + "<td>" + sumC.toFixed(2) + "</td>"
					+ "</tr>";
