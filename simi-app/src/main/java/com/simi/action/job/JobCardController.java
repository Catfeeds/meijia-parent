...
public class JobCardController extends BaseController {
	...
	public AppResultData<Object> SecDo2min(HttpServletRequest request) {
		...
		HashMap<String, String> sendSmsResult = SmsUtil.SendSms(secMobileList.get(i),
				Constants.SEC_TWO_MINUTE, content);
	...
	public AppResultData<Object> SecDo30min(HttpServletRequest request) {
		...
		HashMap<String, String> sendSmsResult = SmsUtil.SendSms(mobileList.get(j),
				Constants.SEC_THIRTY_MINUTE, content);
