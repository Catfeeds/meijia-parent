...
public class WxNotifyOrderSeniorController extends BaseController {
    ...
    */
	...
	@RequestMapping(value = "wxpay-notify-ordersenior.do", method = RequestMethod.POST)
	protected void wxPayNotifyOrderSenior(HttpServletRequest request,
...
//		System.out.println("~~~~~~~~~~~~~~~~付款成功~~~~~~~~~");
		...
		try {
			...
			String url = "http://localhost:8080/simi/app/user/senior_online_pay.json";
