...
public class InsuranceController extends BaseController {
	 ...
	 * @return
	 * 
	 *         { status:xx msg: xx data:{ cityId : xx, regionId : xx,
	 * 
	 *         pensionP(个人) : （录入时的数字,单位%, 转换为数字时需要 除以100） //养老 pensionC（公司） ...
	 * 
	 *         } }
	 * 
	 */
	@RequestMapping(value = "get_insurance.json", method = RequestMethod.GET)
	public AppResultData<Object> getInsurRance(@RequestParam("city_id") Long cityId) {
	...
	public AppResultData<Object> getTaxPersion(@RequestParam(value = "setting_type", required = false, defaultValue = "tax_persion") String settingType) {
