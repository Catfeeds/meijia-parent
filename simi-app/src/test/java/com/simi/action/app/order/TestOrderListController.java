...
public class TestOrderListController extends JUnitActionBase  {
    ...
    public void testList() throws Exception {
		String url = "/app/order/get_list.json";
		
		String params = "?user_id=278&page=1";
    ...
    public void testPartnerList() throws Exception {
		String url = "/app/order/get_partner_list.json";
		
		String params = "?partner_user_id=274&order_id=1";
		MockHttpServletRequestBuilder getRequest = get(url + params);
    ...
    public void testPartnerDetail() throws Exception {
		String url = "/app/order/get_partner_detail.json";
