...
<body>
		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">劳务报酬计算器</strong> / <small>2016版</small>
				</div>
			</div>
			<hr>
			<div class="am-g">
				<form id="taxForm" class="am-form am-form-horizontal" action="" method="POST">
					...
					<div class="am-form-group">
						<label class="am-u-sm-4 am-form-label">劳务报酬<font color="red">*</font></label>
						<div class="am-u-sm-8">
	...
	<script src="<c:url value='/assets/js/xcloud/atools/tools-tax-pay.js'/>"></script>
</body>
</html>
