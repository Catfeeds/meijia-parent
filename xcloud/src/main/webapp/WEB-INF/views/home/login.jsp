...
<body>
	...
	<div class="am-g tr-yunpan">
		...
		<div class="tr-yunpan-container am-container am-container-collapse am-vertical-align">
			<div class="am-vertical-align-middle am-g am-g-collapse" style="width: 100%;">
				...
				>
					<form novalidate="novalidate" id="login-form" class="am-form am-padding-xl am-padding-bottom-sm" method="post">
						<input name="csrfmiddlewaretoken" value="uDnMYubBhhBX7H58nNhwBQKMAu0wWXLw" type="hidden">
						<div class="am-g am-container">
							<h2>登录云行政</h2>
						</div>
						<div class="am-g am-padding-sm">
							<div class="am-form-group am-form-icon">
								<span class="am-icon-user"></span> <input value="" name="username" class="am-form-field am-radius"
									placeholder="手机" required="require" type="text"
								>
							</div>
							<div class="am-form-group am-form-icon">
								<span class="am-icon-lock"></span> <input name="password" class="am-form-field am-radius" placeholder="密码"
									minlength="6" required="" type="password"
								>
							</div>
							<button type="button" id="login-btn" class="am-btn am-btn-danger am-btn-block am-radius">登
								录</button>
			...
			<div class="am-modal-bd">
				<div novalidate="novalidate" id="yunpan-forgotpassword-form" class="am-form am-padding">
					<div class="am-form-group am-input-group">
						<span class="am-input-group-label"><i class="am-icon am-icon-phone"></i></span> <input value=""
							pattern="^1((3|5|8){1}\d{1}|70|77)\d{8}$" id="fp_phone" name="phone"
							class="am-form-field am-radius js-pattern-mobile" placeholder="手机号码" required="" type="text"
						>
					</div>
					<div class="am-form-group am-input-group">
						<span class="am-input-group-label"><i class="am-icon am-icon-suitcase"></i></span> <input value=""
							pattern="^\d{4}$" id="fp_validate_code" name="valiate_code" class="am-form-field am-radius js-pattern-valitecode"
							placeholder="手机短信验证码" data-validation-message="验证失败" required="" type="text"
					...
					<div class="am-form-group am-input-group">
						<span class="am-input-group-label"><i class="am-icon am-icon-lock"></i></span> <input
							id="fp_new_password" name="new_password" class="am-form-field am-radius" placeholder="密码" minlength="6"
							required="" type="password"
						>
					</div>
					<div class="am-form-group am-input-group">
						<span class="am-input-group-label"><i class="am-icon am-icon-lock"></i></span> <input
							id="fp_confirm_password" name="confirm_password" class="am-form-field am-radius" placeholder="确认密码"
							data-validation-message="请确认前后输入密码一致" required="" data-equal-to="#fp_new_password" type="password"
						>
					</div>
					<p>
	...
	<div class="am-g am-padding-vertical-lg tr-yunpan-mutidevice">
		<div class="am-container">
			<ul class="am-text-center">
				<li class="am-u-md-3 am-u-sm-12 am-padding-vertical"><a id="tr-app-desktop-qrcode" href="javascript:void(0);"><span
						class="am-icon am-icon-lg am-icon-desktop"
					></span>&nbsp;&nbsp;Windows&nbsp;&amp;&nbsp;Mac</a></li>
				<li class="am-u-md-2 am-u-sm-12 am-padding-vertical"><a id="tr-app-android-qrcode" href="javascript:void(0);"><span
						class="am-icon am-icon-lg am-icon-android"
					></span>&nbsp;&nbsp;Android</a></li>
				<li class="am-u-md-2 am-u-sm-12 am-padding-vertical"><a id="tr-app-ios-qrcode" href="javascript:void(0);"><span
						class="am-icon am-icon-lg am-icon-apple"
					></span>&nbsp;&nbsp;iOS</a></li>
			...
			<div class="am-modal-dialog">
				...
				<div class="am-modal-bd">
					<div class="am-g am-padding-top">
						<div class="am-u-sm-6">
							<a href="https://app.fangcloud.com/sync/EnterpriseSyncInstaller.exe" title="点击下载" target="_top"
								class="am-icon am-icon-laptop am-icon-lg"
							></a>
							<p>Windows客户端</p>
						</div>
						<div class="am-u-sm-6">
							<a href="https://app.fangcloud.com/sync_mac/EnterpriseSync.pkg" title="点击下载" target="_top"
								class="am-icon am-icon-apple am-icon-lg"
							></a>
							<p>Mac客户端</p>
						</div>
					</div>
	...
	<div class="am-modal am-modal-no-btn" tabindex="-1" id="tr-app-android-modal">
		<div class="am-modal-dialog">
			<div class="am-modal-hd">
				下载Android客户端<a href="javascript:%20void(0)" class="am-close am-close-spin" data-am-modal-close="">×</a>
			</div>
			<div class="am-modal-bd">
				<p>
					<img src="assets/img/netdisk-app-android.jpg" alt="Android客户端" class="am-img-thumbnail am-radius">
				</p>
				<hr>
				<a href="https://app.fangcloud.com/android/enterprise-android-latest.apk" title="Android客户端" target="_top"
					class="am-btn am-btn-primary"
				><i class="am-icon-cloud-download"></i> 立即下载</a>
			</div>
		</div>
	</div>
	<div class="am-modal am-modal-no-btn" tabindex="-1" id="tr-app-ios-modal">
		<div class="am-modal-dialog">
			...
			<div class="am-modal-bd">
				...
				<hr>
				<a href="https://itunes.apple.com/app/id1022310125" target="_top" title="App Store" class="am-btn am-btn-primary"><i
					class="am-icon-apple"
				></i> 前往App Store</a>
			</div>
		</div>
	...
	<div style="top: 381.95px; left: 559.383px;" id="am-popover-nqxeg" class="am-popover am-popover-top">
		<div class="am-popover-inner">
