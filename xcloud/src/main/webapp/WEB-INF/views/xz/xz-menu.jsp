...
<!-- 		<li class="admin-parent"><a class="am-collapsed" onclick="setMenuId('collapse-nav-xz-excel')"> <span
			...
			<ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav-xz-excel">
				<li><a href="#" class="am-cf"> <span class="am-icon-bell"></span> 月报表
				</a></li>
		...
		<li class="admin-parent"><a class="am-cf am-collapsed" onclick="setMenuId('collapse-nav-xz-assets')"> <span
			...
			<ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav-xz-assets">
				<li><a href="/xcloud/xz/assets/commpany_asset_list" class="am-cf"> <span class="am-icon-pencil"></span> 资产登记
				</a></li>
				<li><a href="/xcloud/xz/assets/use_asset_list"> <span class="am-icon-reply"></span> 领用与借用
				</a></li>
				<li><a href="#"> <span class="am-icon-archive"></span> 库存管理
				</a></li>
				<li><a href="admin-404.html"> <span class="am-icon-shopping-cart"></span> 办公用品采购
				</a></li>
		...
		<li class="admin-parent"><a class="am-cf am-collapsed" onclick="setMenuId('collapse-nav-xz-express')"> <span
			...
			<ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav-xz-express">
				<li><a href="/xcloud/xz/express/express-form?id=0" class="am-cf"> <span class="am-icon-pencil"></span> 快递登记
				</a></li>
		...
		<li class="admin-parent"><a class="am-collapsed" onclick="setMenuId('collapse-nav-xz-water')"> <span
				class="am-icon-coffee"></span> 饮用水管理 <span class="am-icon-angle-right am-fr am-margin-right"></span>
		</a>
			<ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav-xz-water">
				<li><a href="/xcloud/xz/water/water-form" class="am-cf"> <span class="am-icon-shopping-cart "></span> 饮用水订购
				</a></li>
		...
		<li class="admin-parent"><a class="am-collapsed" onclick="setMenuId('collapse-nav-xz-clean')"> <span
				class="am-icon-bitbucket"></span> 企业保洁 <span class="am-icon-angle-right am-fr am-margin-right"></span>
		</a>
			<ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav-xz-clean">
				<li><a href="/xcloud/xz/clean/clean-form" class="am-cf"> <span class="am-icon-phone"></span> 保洁预约
				</a></li>
		...
		<li class="admin-parent"><a class="am-collapsed" onclick="setMenuId('collapse-nav-xz-recycle')"> <span
				class="am-icon-recycle"></span> 废品回收 <span class="am-icon-angle-right am-fr am-margin-right"></span>
		</a>
			<ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav-xz-recycle">
				<li><a href="/xcloud/xz/recycle/recycle-form" class="am-cf"> <span class="am-icon-phone"></span> 回收预约
				</a></li>
		...
		<li class="admin-parent"><a class="am-cf am-collapsed" onclick="setMenuId('collapse-nav-xz-meeting')"> <span
				class="am-icon-university"></span> 会议室管理 <span class="am-icon-angle-right am-fr am-margin-right"></span>
		</a>
			<ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav-xz-meeting">
				<li><a href="/xcloud/xz/meeting/list" class="am-cf"> <span class="am-icon-calendar"></span> 会议一览
				</a></li>
