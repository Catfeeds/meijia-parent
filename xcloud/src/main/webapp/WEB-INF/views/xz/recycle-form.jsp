...
<body>
		...
		<div class="admin-content">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">废品回收服务下单</strong> / <small>废品回收服务需求详情</small>
				</div>
			</div>
			<hr>
			...
			<div class="am-g">
				...
				<div class="am-u-sm-12 am-u-md-4 am-u-md-push-8">
					...
					菠萝小秘提示您 </header>
					<div class="am-panel-bd">可以用APP一键扫码预约废品回收服务，快来试试吧~~</div>
					<div class="am-panel-bd"><center><img src="<c:url value='${qrCode }'/>" width="200" height="200" /></center></div>
					</section>
				</div>

				<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
					<form:form modelAttribute="contentModel" method="POST" id="recycle-form"
						class="am-form am-form-horizontal" enctype="multipart/form-data">
                        <input type="hidden" id="userId" value="${userId }" />
						
						    <div class="am-form-group">
							<label for="user-phone" class="am-u-sm-3 am-form-label">废品类型:</label>
							<div class="am-u-sm-9">
						      <select id="recycleType">
						        <option value="0">日常办公垃圾</option>
						        <option value="1">废旧电器</option>
						        <option value="2">硒鼓墨盒</option>
						...
						<div class="am-form-group">
							<div class="am-u-sm-9 am-u-sm-push-3">
								<button type="button" class="am-btn am-btn-danger" id="btn-recycle-submit">提交</button>
	...
	<script src="<c:url value='/assets/js/xcloud/xz/recycle-form.js'/>"></script>
</body>
</html>
