...
<body>
		...
		<div class="admin-content">
			...
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">办公环境服务记录</strong> / <small>办公环境服务记录一览</small>
				</div>

				<div class="am-u-sm-12 am-u-md-3 am-fr">
					<div class="am-btn-toolbar am-fr">
						<div class="am-btn-group am-btn-group-sm ">
							<button type="button" id="btn-clean-add" class="am-btn am-btn-warning am-radius">
				...
				<div class="am-u-sm-12">
					<form class="am-form">
						...
						<c:import url="../shared/paging.jsp">
							...
							<c:param name="urlAddress" value="/xz/clean/list" />
						</c:import>
					</form>
				</div>
			</div>
	...
	<script src="<c:url value='/assets/js/xcloud/xz/clean-list.js'/>"></script>
</body>
</html>
