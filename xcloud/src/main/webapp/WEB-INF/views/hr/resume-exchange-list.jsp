...
<body>
		...
		<div class="admin-content">
			...
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">简历交换列表</strong> / <small>简历交换信息一览</small>
				</div>
				...
				<div class="am-u-sm-12">
					<form class="am-form">
						<table id="list-table" class="am-table am-table-bordered am-table-striped am-table-centered">
							...
							<tbody>
								<c:forEach items="${resumeExChangeModel.list}" var="item">
									<tr>
										<td>${item.name}</td>
										<td>${item.cityName}</td>
						...
						<c:import url="../shared/paging.jsp">
							<c:param name="pageModelName" value="resumeExChangeModel" />
							<c:param name="urlAddress" value="/hr/resume/resume_exchange_list" />
						</c:import>
					</form>
				</div>
			</div>
	...
	<script src="<c:url value='/assets/js/xcloud/hr/resume-exchange-list.js'/>"></script>
</body>
</html>
