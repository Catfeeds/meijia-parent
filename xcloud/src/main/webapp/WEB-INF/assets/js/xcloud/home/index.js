...
$.ajax({
	type : "get",
	url : "http://51xingzheng.cn/?json=get_category_posts&count=5&order=DESC&id=64&include=id,title,url,custom_fields&page=1",
	dataType : "JSONP",
	async : true,
	success : function(rdata, textStatus) {
		var datas = rdata.posts;
...
$.ajax({
	type : "get",
	url : "http://51xingzheng.cn/?json=get_category_posts&count=5&order=DESC&id=62&include=id,title,url,custom_fields&page=1",
	dataType : "JSONP",
	async : true,
	success : function(rdata, textStatus) {
		var datas = rdata.posts;
...
$.ajax({
	type : "get",
	url : "http://51xingzheng.cn/?json=get_category_posts&count=5&order=DESC&id=65&include=id,title,url,custom_fields&page=1",
	dataType : "JSONP",
	async : true,
	success : function(rdata, textStatus) {
		var datas = rdata.posts;
